...
: ${AMENT_CURRENT_PREFIX:="/root/rf-data-collection/install/imu-ros2node"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/imu-ros2node/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/imu-ros2node/environment/path.sh"
